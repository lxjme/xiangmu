...
<div id="MainArea">
        ...
        <tbody id="TableData">
			...
			<c:forEach items="${list}" var="dt" varStatus="st"  >
				<tr class="TableDetail1">
					...
					<td align="center"> ${dt.type_name}&nbsp;</td>
					<td align="center">
						<a href="updateFoodType?id=${dt.id}&type_name=${dt.type_name}" class="FunctionButton">更新</a>				
						<a href="deleteFoodType?id=${dt.id}" onClick="return delConfirm();"class="FunctionButton">删除</a>				
					</td>
				</tr>
			</c:forEach>
   ...
   <!-- 其他功能超链接 -->
	<div id="TableTail" align="center">
		<div class="FunctionButton"><a href="saveFoodType">添加</a></div>
    </div> 
</div>
</body>
</html>
