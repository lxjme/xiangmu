...
class ShujiController extends Controller {
    ...
    public function index(){
        $res_data = DB::table('books')->where(['f_type'=>2])->paginate(10);

        return view('shuji.list')->with('list_data', $res_data);
    }
    ...
    public function artList($id) {
        ...
        return view('shuji.art_list')->with([
            'book_res'=>$book_res,
    ...
    public function artDetail($id) {
        ...
        // 
        return view("shuji.art_detail")->with([
